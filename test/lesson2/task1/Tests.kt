...
class Tests {
    ...
    fun timeForHalfWay() {
        ...
        assertEquals(3.0, timeForHalfWay(1.0, 0.0, 1.0, 0.0, 2.0, 10.0), 1e-2)
        assertEquals(1.39, timeForHalfWay(1.07, 4.0, 0.0, 3.0, 1.07, 10.0), 1e-2)
    }
    ...
    fun rookOrBishopThreatens() {
        ...
        assertEquals(2, rookOrBishopThreatens(8, 1, 7, 6, 2, 7))
    }
