...
class Tests {
    ...
    fun bagPacking() {
        ...
        assertEquals(
                setOf("0", "1", "2", "3", "5", "6", "8", "9", "10", "11", "12"),
                bagPacking(
                        mapOf("0" to (148 to 149), "1" to (99 to 399), "2" to (274 to 252),
                                "3" to (1 to 44), "4" to (451 to 1), "5" to (148 to 148),
                                "6" to (2 to 148), "7" to (411 to 97), "8" to (1 to 148),
                                "9" to (2 to 341), "10" to (148 to 149), "11" to (68 to 1), "12" to (149 to 491)),
                        1307
                )
        )
    }
